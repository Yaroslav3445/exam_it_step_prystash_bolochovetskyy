    ...
    return (
        <>
            <div className={s.card}>
                ...
                <strong className={s.title}> Максимов Максимов
                </strong>
                <div className={s.card__body}>
                    Ведучий
                </div>
                <span><strong className={s.title}> Максимов Максимов
                </strong>
                    <div className={s.card__body}>
                        Ведучий
            ...
            <div className={s.card}>
                ...
                <strong className={s.title}> Єва Райська
                </strong>
                <div className={s.card__body}>
                    Ведучий
                </div>
                <span><strong className={s.title}> Єва Райська
                </strong>
                    <div className={s.card__body}>
                        Ведучий
                        <p>Автор та редактор подкасту "Франкова земля”</p>
